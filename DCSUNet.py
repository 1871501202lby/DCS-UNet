...
from sam2.modeling.DCA import DCA
from sam2.build_sam import build_sam2
import timm
from sam2.modeling.PFA import PFA2D
...
class DCSUNet(nn.Module):
    def __init__(self, checkpoint_path=None) -> None:
        super(DCSUNet, self).__init__()
        ...
        self.dca = DCA([64, 64, 64, 64])

        self.pfa1 = PFA2D(64, 64, (11, 11))
        self.pfa2 = PFA2D(64, 64, (22, 22))
        self.pfa3 = PFA2D(64, 64, (44, 44))
